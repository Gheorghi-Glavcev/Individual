...
class Teacher extends \App\Entity\Teacher implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Teacher' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Teacher' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Teacher' . "\0" . 'lesson', '' . "\0" . 'App\\Entity\\Teacher' . "\0" . 'Students'];
        }
     ...
     * {@inheritDoc}
     */
    public function setLesson(string $lesson): \App\Entity\Teacher
    {
     ...
     * {@inheritDoc}
     */
    public function addStudent(\App\Entity\Student $Student): \App\Entity\Teacher
    {
     ...
     * {@inheritDoc}
     */
    public function removeTeacher(\App\Entity\Student $Student): \App\Entity\Teacher
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeTeacher', [$Student]);

        return parent::removeTeacher($Student);
    }
